...
- **Administrative Tools**: Admin panel for moderation, user management, configuration, support ticket management, frame management, user online statistics, broadcast messaging, and mentor top-up statistics dashboard. Includes super admin whitelist for sensitive operations like credit top-ups, email changes, and password resets. Admin mentor statistics feature displays aggregated mentor performance data including total/monthly top-ups, active mentor count, top 10 mentor rankings, and detailed mentor list with subscription status (October 2025).
