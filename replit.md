...
- **Room info structure**: Uses same View-based row structure as regular messages (without badge) - paddingHorizontal: 0 to match messageContainer (parent messagesContainer already has padding: 12)
