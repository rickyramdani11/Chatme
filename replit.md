...
- **Avatar Frame Display**: Proportional frame sizing across screens - ProfileScreen (120px avatar/136px frame), TopRankScreen (50px avatar/58px frame), FeedScreen (40px avatar/46px frame). Frames shown in rankings (games/wealth/gifts) and feed posts with AnimatedFrameOverlay component.
