...
- **Room Creation Limits**: Room name limited to 50 characters, description limited to 50 characters for consistent UI/UX.
...
- **Avatar Frame Display**: Proportional frame sizing across screens - ProfileScreen (88px avatar/120px frame with 16px offset), TopRankScreen (40px avatar/60px frame with 10px offset), FeedScreen (30px avatar/50px frame with 10px offset). All frames use relative positioning without position: absolute for consistent layering and perfectly centered alignment. Frames shown in rankings (games/wealth/gifts) and feed posts with AnimatedFrameOverlay component.
