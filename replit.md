...
- **Merchant/Mentor TOP UP System**: Monthly subscription-based system where merchants top up 800k/month to mentors and mentors top up 7M/month to system. Top ups can be made in installments throughout the month. Merchants failing to meet 800k requirement are auto-downgraded to 'user' role. Mentors failing to meet 7M requirement are downgraded and lose mentor status. All users (including merchants/mentors) receive standard 30% gift earnings to withdraw balance (top up system is separate from gift earnings).
