...
- **ProfileScreen Design**: Compact button/badge design with purple-red gradient (#9333ea → #dc2626) for Follow, Message buttons and Family Badge. Button sizes reduced (padding: 18px/10px, fontSize: 14px, icons: 16px). Album section protected from over-scrolling with ScrollView bounces disabled and contentContainerStyle paddingBottom: 40px. Username displays with inline level badge format "username [Lv X]" using purple color (#9333ea), fontSize 18px.
