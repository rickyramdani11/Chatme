...
import Clipboard from '@react-native-community/clipboard'; // Import Clipboard
...
export default function ChatScreen() {
  ...
  const renderMessage = ({ item }: { item: Message }) => {
    ...
    // Handle usercommand input (when user types /roll, /whois, etc.) - Legacy support
  ...
  const loadGifts = async () => {
    try {
      ...
      const localGifts = [
        ...
        {
          id: '1008',
          name: 'DoaBintang', icon: '⭐', price: 10000000, type: 'animated', category: 'tas saya' },
      ];
